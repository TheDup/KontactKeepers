...
namespace FmAPI
{
    class FBAccess
    {
        private string messengerAPItoken = "EAAiZApOi1Kb4BAGlGVA93ccXecvz74t9iG3o98VfbJBC1MkbZAX8k3a41LKAjTKdZATP0e7SQZCmY7sAsT8sbB2wctMob41bJwPlq2TW4I0E53BzE1CE9eeCcg0wrGhlCuJlr6HPkNJ0h40G36GKZBH0gv5oD7mNWWzesshhd8QZDZD";
        static void Main(string[] args)
        {
            MessengerAPI obj = new MessengerAPI(messengerAPItoken);
        ...
        {
            string facebookToken = messengerAPItoken;
